...
class AllProductsSection extends Component {
  ...
  getProducts = async () => {
    ...
    const apiUrl = `https://apis.ccbp.in/products?sort_by=${activeOptionId}&title_search=${titleSearch}&rating=${rating}&category=${category}`
    const options = {
      headers: {
    ...
    return (
      <div className="all-products-section">
        ...
        <FiltersGroup
          ...
          onRatingClicked={this.onRatingClicked}
